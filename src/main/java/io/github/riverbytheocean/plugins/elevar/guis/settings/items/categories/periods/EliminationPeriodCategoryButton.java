...
public class EliminationPeriodCategoryButton extends AbstractItem {
        ...
        return new ItemBuilder(Material.STONE_SWORD)
                .setDisplayName(
                        new AdventureComponentWrapper(
                                Component.text("Elimination Period Settings")
                                        .decoration(TextDecoration.ITALIC, false)
                                        .decoration(TextDecoration.BOLD, true)
                        ))
                .addLoreLines(
                        new AdventureComponentWrapper(
                                Component.text("Settings related to the elimination period!")
                                        .decoration(TextDecoration.ITALIC, false)
    ...
    public void handleClick(@NotNull ClickType clickType, @NotNull Player player, @NotNull InventoryClickEvent inventoryClickEvent) {
        ...
        ElevarSettingsGUI.sendEliminationPeriodSettingsGUI(player);
