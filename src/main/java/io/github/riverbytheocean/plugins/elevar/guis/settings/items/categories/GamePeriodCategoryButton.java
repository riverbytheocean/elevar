...
public class GamePeriodCategoryButton extends AbstractItem {
        ...
        return new ItemBuilder(Material.BOW)
                .setDisplayName(
                        new AdventureComponentWrapper(
                                Component.text("Game Period Settings")
                                        .decoration(TextDecoration.ITALIC, false)
                                        .decoration(TextDecoration.BOLD, true)
                        ))
                .addLoreLines(
                        new AdventureComponentWrapper(
                                Component.text("Settings related to the game periods!")
                                        .decoration(TextDecoration.ITALIC, false)
    ...
    public void handleClick(@NotNull ClickType clickType, @NotNull Player player, @NotNull InventoryClickEvent inventoryClickEvent) {
        ...
        ElevarSettingsGUI.sendGamePeriodSettingsGUI(player);
