...
public class SecondPVPDamageToggleItem extends AbstractItem {

    @Override
    public ItemProvider getItemProvider() {

        Material material = Elevar.getInstance().getConfig().getBoolean("second-period.damage.pvp") ? Material.DIAMOND_SWORD : Material.STICK;
        ...
        return new ItemBuilder(material)
                ...
                .addLoreLines(
                        ...
                        new AdventureComponentWrapper(
                                Component.text("This is currently set to " + Elevar.config().getBoolean("second-period.damage.pvp") + "!")
                                        .decoration(TextDecoration.ITALIC, false)
    ...
    public void handleClick(@NotNull ClickType clickType, @NotNull Player player, @NotNull InventoryClickEvent inventoryClickEvent) {
        ...
        Elevar.config().set("second-period.damage.pvp", !Elevar.getInstance().getConfig().getBoolean("second-period.damage.pvp"));
